        ...
        <div class="section-title">
          <h2><span>View</span> Request</h2>
				...
				<div class="row">
                    ...
                    /*    ResultSet rs=st.executeQuery("select createpackup.id,createpackup.r_name,createpackup.r_address,createpackup.r_pin,createpackup.item,user.name,user.address,createpackup.hashcode,createpackup.status,createpackup.statusss from createpackup inner join user on createpackup.email=user.email");
                       */ 
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	do{	 
                    	 ...
                    	 <th><a class="btn-get-startedd" href="UpdatePackupStatusssController?id=<%=rs.getInt(1)%>&statusss=<%=rs.getString(28)%>"><%=rs.getString(28)%></a></th> 
                          <th><a href="AddShipment.jsp?hashcode=<%=rs.getString(25)%>"><%=rs.getString(25)%></th>
<%--  <td><a href="DeleteRequestCon?id=<%=rs.getInt(1)%>"><img alt="" src="assets/img/delete.jpg" width="40px;" height="40px;"><b></b></a></td> 
                    	 --%>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
