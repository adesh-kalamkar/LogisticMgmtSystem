    ...
    <section id="contact" class="contact" style="background-color:#000;">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span>Delivery Person</span> Login</h2>
          
        </div>
 
        
       
         <form action="DeliveryPersonLoginController" method="post" class="formone">
          <div class="row">
          ...
          <br>
       <div class="text-center"><button type="submit" class="btn-get-started">Login</button><br><br>
       <a href="DeliveryPersonRegistration.jsp" style="color:red">Not yet register...Register here!!!</a>
